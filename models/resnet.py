...
def resnet20(num_classes):
    return ResNet_CIFAR(depth=20,num_classes = num_classes ,cfg=cifar_cfg[20])

def resnet20_X(num_classes , nums=None):
    return ResNet_CIFAR(depth=20,num_classes = num_classes ,cfg=nums)
def resnet56(num_classes):
    return ResNet_CIFAR(depth=56,num_classes = num_classes ,cfg=cifar_cfg[56])
def resnet56_X(num_classes, nums=None):
    return ResNet_CIFAR(depth=56,num_classes = num_classes ,cfg=nums)
def resnet44(num_classes):
    return ResNet_CIFAR(depth=44,num_classes = num_classes ,cfg=cifar_cfg[44])
def resnet44_X(num_classes , nums=None):
    return ResNet_CIFAR(depth=44,num_classes = num_classes ,cfg=nums)
def resnet110(num_classes):
    return ResNet_CIFAR(depth=110,num_classes = num_classes ,cfg=cifar_cfg[110])
def resnet110_X(num_classes, nums=None):
    return ResNet_CIFAR(depth=110,num_classes = num_classes ,cfg=nums)