...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.downsample is not None:
            ...
            if self.conv1.out_channels == 1:
                return self.relu(self.downsample(x))
...
def pruned_resnet50(pretrained=False, cfg=None , dataset = None):
    ...
    model = ResNet(Bottleneck, [3, 4, 6, 3], cfg , num_classes = num_class)
